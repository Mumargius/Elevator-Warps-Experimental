...
public class WarpBlocks {
    public static final DeferredRegister<Block> BLOCKS =
        DeferredRegister.create(ForgeRegistries.BLOCKS, TutorialWarps.MODID);
    ...
    //The special block
    public static final RegistryObject<Block> SPECIALBLOCK= registerBlock("specialblock",
        ()-> new SpecialBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.AMETHYST)));
